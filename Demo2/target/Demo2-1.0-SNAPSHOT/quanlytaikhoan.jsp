<%-- 
    ...
    Created on : Dec 19, 2020, 1:01:04 PM
    Author     : PC
--%>
                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap py-5">
                                        <div class="card-title">
                                            <h3 class="card-label">Quản Lý Tài Khoản</h3>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 1231px;">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 134px;" aria-label="Agent: activate to sort column descending" aria-sort="ascending">User</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 134px;" aria-label="Company Email: activate to sort column ascending">Email</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 134px;" aria-label="Company Agent: activate to sort column ascending">Province</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 134px;" aria-label="Company Name: activate to sort column ascending">Date Created</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 62px;" aria-label="Status: activate to sort column ascending">Permission</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 41px;" aria-label="Type: activate to sort column ascending">State</th>
                                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 111px;" aria-label="Actions">Actions</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:forEach var="us" items="list_useracc">
                                                                <tr role="row" class="even">
                                                                    <td class="sorting_1 dtr-control">
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="symbol symbol-50 flex-shrink-0">
                                                                                <img src="<c:out value="${us.getName_user()}"/>" alt="photo">
                                                                            </div>
                                                                            <div class="ml-3">
                                                                                <span class="text-dark-75 font-weight-bold line-height-sm d-block pb-2"><c:out value="${us.getName_user()}"/></span>
                                                                                <a href="#" class="text-muted text-hover-primary"></a>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <a class="text-dark-50 text-hover-primary" href="mailto:alarkingg@elegantthemes.com"><c:out value="${us.getEmail()}"/></a>
                                                                    </td>
                                                                    <td><c:out value="${us.getName_province()}"/></td>
                                                                    <td><c:out value="${us.getDate_in()}"/></td>
                                                                    <td>
                                                    ...
                                                    <div class="dataTables_paginate paging_simple_numbers" id="kt_datatable_paginate">
                                                        <ul class="pagination">
                                                            ...
                                                            <li class="paginate_button page-item next" id="kt_datatable_next">
                                                                <a href="#" aria-controls="kt_datatable" data-dt-idx="6" tabindex="0" class="page-link">
