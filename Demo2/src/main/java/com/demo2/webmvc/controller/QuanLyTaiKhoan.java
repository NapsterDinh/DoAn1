 ...
 * @author PC
 */
@WebServlet(urlPatterns = {"/QuanLyTaiKhoan"})
public class QuanLyTaiKhoan extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<UserAccount> list_useracc = DBUtils.Load_UserAccount_All(conn);
            session.setAttribute("list_useracc", list_useracc); 
        
        
        RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/quanlytaikhoan.jsp");
