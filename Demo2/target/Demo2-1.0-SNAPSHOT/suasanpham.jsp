<%-- 
    Document   : suasanpham
    Created on : Dec 19, 2020, 12:23:37 PM
    Author     : PC
--%>
                                    ...
                                    <form class="form" method="post">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-3">
                                                    <input name="nameProduct" type="text" class="form-control" placeholder="<c:out value="${Product.getName_product()}"/>">
                                                </div>
                                                <label class="col-lg-2 col-form-label text-lg-right">Category</label>
                                                <div class="col-lg-3">
                                                    <div class="dropdown bootstrap-select form-control">
                                                        <div class="dropdown bootstrap-select form-control">
                                                            <select class="form-control selectpicker" name="cagetoryProduct" ><c:out value="${Product.getId_Category()}"/>
                                                                <option class="cagetory" name="computer" value="1">Computer And Accessories</option>
                                                                <option class="cagetory" name="audio" value="2">Audio</option>
                                                                <option class="cagetory" name="laptop" value="3">Laptop</option>
                                                                <option class="cagetory" name="tv" value="4">TV</option>
                                                                <option class="cagetory" name="mobile" value="5">Mobile</option>
                                                                <option class="cagetory" name="headphone" value="6">Head Phones</option>
                                                                <option class="cagetory" name="battery" value="7">Battery</option>
                                                                <option class="cagetory" name="watches" value="8">Watches</option>
                                                                <option class="cagetory" name="camera" value="9">Camera</option>
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="input-group">
                                                        <input id="kt_touchspin_1" type="text" class="form-control" value="<c:out value="${Product.getPrice()}"/>" name="priceProduct" placeholder="">
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <div class="input-group  bootstrap-touchspin bootstrap-touchspin-injected">
                                                        <input id="kt_touchspin_4" type="text" class="form-control bootstrap-touchspin-vertical-btn" value="<c:out value="${Product.getAmount()}"/>" name="amountProduct" placeholder="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="image-input image-input-outline" id="kt_image_1">
                                                        <div class="image-input-wrapper" style="background-image: url(products/<c:out value="${Product.getImage()}"/>)"></div>
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <textarea class="form-control" id="kt_clipboard_2" rows="6" name="descriptionProduct" placeholder="<c:out value="${Product.getDescription()}"/>"></textarea>
                                                </div>
                                            </div>
                                        </div>
