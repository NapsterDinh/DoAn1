<%-- 
    Document   : Verify
    Created on : Dec 12, 2020, 2:08:23 PM
    Author     : Napster
--%>
        ...
        <section class="login-area ptb-50">
            <div class="container">
                <div style="text-align: center;" class="login-form">
                    ...
                    <h1 style="padding-bottom: 15px;">Thanks for registering</h1>
                    <h6>We have just send a verification email to you</h6>
                    <h6>Pleas check your email and finish last step to be our customer</h6>
                    <h6>Thank you</h6>
                </div>
            </div>
        </section>
