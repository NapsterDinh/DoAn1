            ...
            <div class="container">
                <div class="wishlist-table table-responsive">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <c:forEach var="Order" items="${list_or}">
                                <tr>
                                ...
                                <td class="product-thumbnail">
                                    <span class="unit-amount"><c:out value="${Order.getId_order()}"/></span>
                                </td>

                                <td class="product-name">
                                    <span class="unit-amount"><c:out value="${Order.getDate_order()}"/></span>
                                </td>

                                <td class="product-price">
                                    <span class="unit-amount">$<c:out value="${Order.getTotal()}"/></span>
                                </td>
                                <c:if test = "${Int.Order.getState() ne '1'}">
                                        <td class="product-stock">
                                            <span style="color:green" class="stock"><c:out value="Not Confirm"/></span>
                                        </td>
                                </c:if>
                                <c:if test = "${Int.Order.getState() eq '1'}">
                                       <td class="product-stock">
